...
function docProcessor(garmentProduct) {
    ...
    this.moveOneLineDown = function () {
        this.yPosition += jsPdfDoc.internal.getLineHeight();
    };
    this.colors = {
    ...
    this.createPageOne = function () {
        ...
        var numInitialRightOfGrid = jsPdfDoc.internal.pageSize.width - (xMarginReset * 2)
        ...
        this.processTextUsingCurrentXandYPosition(strBrand, 0, -3);
        this.moveOneLineDown();
        //this.processTextUsingCurrentXandYPosition(strDesigner, 0, -3);
        this.processTextUsingCurrentXandYPosition(strConstructionMethodCode, 0, -3);
        this.moveOneLineDown();
    ...
    this.processColorwayDataTableResponseArray = function (objCurrentColorwayToProcess, yOffsetPerLine, numMaxCharacterLength, boolProcessForPdf) {
        ...
        if (boolProcessForPdf) {
            ...
            for (var k = 0; k < this.arrayOfArraysToProcess.length; k++) {
                ...
                var arrOfColumnWidths = [25, 25, 25, 32, 30];// need to add functionality to compress around the header
    ...
    this.addRevisionTable = function () {
        if ($("#revisionAttributeTbl").length) {
            ...
            var arrOfColumnWidths = [15, 50, 50, 50, 35, 115, 35, 35];
        ...
        if ($(".construction").length) {
            ...
            for (var i = 0; i < arrOfConstructions.length; i++) {
                try {
                    ...
                    var arrOfColumnWidths = [70/*Sewing Operation*/, 54/*Stitch Type Description*/, 45/*Gauge Width*/, 20/*SPI*/, 45/*Seam Trimoff Allowance*/, 30/*Garment Use*/, 30/*Needle Thread*/, 30/*Needle Visibility*/, 36/*Looper Thread*/, 33/*Looper Visibility*/];
    ...
    this.runAndSave = function () {
        ...
        this.resetXbutSpecifyY(this.yPosition);
        jsPdfDoc.outline.add(this.node, 'General Attributes', { pageNumber: pageNumber });
        /*var dooper = function () {
            this.header();
        };*/
