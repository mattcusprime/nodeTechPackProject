...
function pdfSpec(productToSpec) {
    ...
    function addFrontBackImage() {
        var frontImageSrc = $('#frontSketch img:first').attr('src');
        //var strFrontImageSrcMinusPrefix = frontImageSrc.substring(22, frontImageSrc.length);
        var objFrontImage = {};
        objFrontImage.image = frontImageSrc;
        objFrontImage.fit = [50, 50]

        docDefinition.content.push(objFrontImage);
    };
    ...
    var imageWidthToFitTo = 500;//docDefinition.pageSize.width + fitDifferentiatorWidth;
    var imageHeightToFitTo = 500;//docDefinition.pageSize.height - fitDifferentiatorHeight;
    docDefinition.pageOrientation = 'landscape';
    ...
    if ($("#measurements").length) {
        ...
        var arrHeaderRowLength = arrMeasurementTbl[0].length;
        var arrWidths = [];
        for (var i = 0; i < arrHeaderRowLength; i++) {
            arrWidths.push('auto');
        };
        var objTextObject = {};
        ...
        addFrontBackImage();
        docDefinition.content.push(objTextObject);
            ...
            for (var k = 0; k < arrRowArr.length; k++) {
                try {
                    if (arrOfIndexesOfInvisibleColumns.indexOf(k) != -1) {
                        ...
                        if (arrRowArr[k].length <= 1) {
                            //arrRowArr[k] = " ---  ";
                            arrRowArr[k] = strBlankFiller
                        };
