...
garmentProduct.prototype.getSpecComponentsForActiveSpec = function(strHostUrlPrefix, objDocumentData, objConstructionData, objMeasurementData, objBomData, objProdLinkData, objGarmentSewBomData, objPatternSewBomDataWithUsage, objSelfReference) {
	...
	$('row', objProdLinkData).each(function(index) {
		...
		if (index == 0) {
			...
			var arrOfTranslations = ['Designer', 'Product_Manager', 'Pattern_Iteration', 'HBI_Division', 'Brand', 'Construction_Method_Code', 'APS_Corp_Division', 'Imperfect_Style', 'Irregular_Style', 'Pattern_Version'];
		...
		for (var i = 0; i < objSelfReference.colorwayProduct.colorwayBomDetail.length; i++) {
			try {
				...
				if (objRow.inGarmentProduct) {
					strThisRow = '<tr id="' + strIdToUse + '">' + '<td>' + objRow.Branch_Id + '</td>' + '<td>' + objRow.partName + '</td>' + '<td>' + objRow.garmentUseBranchId + '</td>' + '<td>' + objRow.Material + '</td>' + '<td>' + objRow.fiberContent + '</td>';
				} else {
					strThisRow = '<tr class="selected" id="' + strIdToUse + '">' + '<td>' + objRow.Branch_Id + '</td>' + '<td>' + objRow.partName + '</td>' + '<td>' + objRow.garmentUseBranchId + '</td>' + '<td>' + objRow.Material + '</td>' + '<td>' + objRow.fiberContent + '</td>';
				};
