    ...
    garmentProduct.prototype.getColorwayBoms = function (strUrlPrefix, objSelfReference) {
        ...
        $.when(objDefferedBranch, objDefferedSkuData, objDefferedColorways, objDefferedAllGarmentMaterials).done(function (objDefferedBranch, objDefferedSkuData, objDefferedColorways, objDefferedAllGarmentMaterials) {
            ...
            var initCwayString2 = '" class="tblCbomTable display responsive col-md-12 compact cell-border"><thead><tr><th>Branch Id</th><th>Part Name</th><th>Garment Use</th><th>Material</th><th>Design Comments</th><th class="lastBeforeSkip">Fiber Content</th>';
            ...
            for (var i = 0; i < objSelfReference.colorwayProduct.colorwayBomDetail.length; i++) {
                try {
                    ...
                    if (objRow.inGarmentProduct) {
                        strThisRow = '<tr id="' + strIdToUse + '">' + '<td>' + objRow.Branch_Id + '</td>' + '<td>' + objRow.partName + '</td>' + '<td>' + objRow.garmentUseBranchId + '</td>' + '<td>' + objRow.Material + '</td>' + '<td>' + objRow.designComments + '</td>' + '<td>' + objRow.fiberContent + '</td>';
                    } else {
                        strThisRow = '<tr class="selected" id="' + strIdToUse + '">' + '<td>' + objRow.Branch_Id + '</td>' + '<td>' + objRow.partName + '</td>' + '<td>' + objRow.garmentUseBranchId + '</td>' + '<td>' + objRow.Material + '</td>' + '<td>' + objRow.designComments + '</td>' + '<td>' + objRow.fiberContent + '</td>';
                    };
