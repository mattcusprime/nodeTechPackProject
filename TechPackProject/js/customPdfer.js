...
function pdfSpec(productToSpec) {
	...
	var fitDifferentiatorWidth = 100;
	var fitDifferentiatorHeight = 550;
	...
	if ($("#constructionDiv table").length) {
		$("#constructionDiv table").each(function() {
